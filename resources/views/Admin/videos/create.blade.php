									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" name="video_subject" class="form-control" required>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												...
												<input class="form-control-file" type="file" name="video_file" required>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Date</label>
                                                <input name="video_date" class="datepicker-default form-control" id="Video_date" placeholder="d-m-y" required>
