        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>videos Details</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">videoss</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">videos Details</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-xxl-4 col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <img class="img-fluid" src="{{ asset('admin/images/courses/pic1.jpg') }}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <p>{{ $video->video_subject }}</p>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong>Date</strong>
                                        <span class="mb-0">{{ $video->video_date }}</span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong>Class</strong>
                                        <span class="mb-0">{{ $video->Classes->class_name  }}</span>
                                    </li>
            ...
            <div class="col-xl-9 col-xxl-8 col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-primary">Our videoss</h4>
                        ...
                        <h4 class="text-primary">videoss Information</h4>
