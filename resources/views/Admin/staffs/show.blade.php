                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
                                ...
                                <p class="text-white mb-0">{{ $staff->role->name }}</p>
                            </div>
                                    ...
                                    <div id="about-me" class="tab-pane fade active show">
                                        ...
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{ $staff->name }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{ $staff->email }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{ $staff->status ? 'Active' : 'Not Active' }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{ $staff->phone_number }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{ $staff->address }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
