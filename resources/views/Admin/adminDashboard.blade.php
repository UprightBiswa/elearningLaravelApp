                        ...
                        <div class="card-body">
                            <div class="media mb-3 align-items-center border-bottom pb-3">
                                ...
                                <div class="media-body">
                                    <h5 class="mb-0 text-pale-sky">Theodore Handle <small class="text-muted">( B.Com
                                            )</small></h5>
                            ...
                            <div class="media mb-3 align-items-center border-bottom pb-3">
                                ...
                                <div class="media-body">
                                    <h5 class="mb-0 text-pale-sky">Bess Willis <small class="text-muted">( M.Com )</small>
                                    </h5>
                            ...
                            <div class="media mb-3 align-items-center border-bottom pb-3">
                                ...
                                <div class="media-body">
                                    <h5 class="mb-0 text-pale-sky">James Jones <small class="text-muted">( M.Tach )</small>
                                    </h5>
                                    <small class="text-primary mb-0">Available</small>
                                </div>
                            </div>
                            ...
                            <div class="media mb-2 align-items-center border-bottom pb-3">
                                ...
                                <div class="media-body">
                                    <h5 class="mb-0 text-pale-sky">Morese Sharpe <small class="text-muted">( B.A, M.A
                                            )</small></h5>
                                    <small class="text-primary mb-0">Available</small>
                                </div>
                            </div>
                            <div class="text-center pt-3">
                                <a href="javascript:void(0);" class="btn btn-primary btn-rounded btn px-5 btn-lg">View
                                    All</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="images/profile/education/pic1.jpg"
                                                            class="rounded-circle" width="35" alt=""></td>
                                                    <td>Angelica Ramos</td>
