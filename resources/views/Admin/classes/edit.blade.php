									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                                ...
                                                <input name="class_date" class="datepicker-default form-control" id="class_date" placeholder="d-m-y" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $class->class_date)->format('d-m-y') }}" required>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                                ...
                                                <input name="class_time" class="timepicker-default form-control" id="class_time" placeholder="HH:mm" value="{{ \Carbon\Carbon::parse($class->class_time)->format('H:i') }}" required>
