        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">exam Details</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">About exam</h2>
                            </div>
                            <div class="card-body pb-0">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        ...
                                        <span class="mb-0">{{ $exam->exam_duration }}</span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                    ...
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        ...
                                        <span class="mb-0">{{ $exam->Classes->class_name }}</span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong>Date</strong>
                                        <span class="mb-0">{{ $exam->exam_date }}</span>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="col-xl-9 col-xxl-8 col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-primary">Our exams</h4>
                        ...
                        <h4 class="text-primary">exams Information</h4>
