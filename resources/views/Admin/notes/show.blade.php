                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <li class="list-group-item border-0 px-0">
                                ...
                                <!-- Display PDF using <object> element -->
                                <div class="embed-responsive embed-responsive-16by9">
                                    <object data="{{ url($note->note_file) }}" type="application/pdf" class="embed-responsive-item">
                                        <!-- If PDF is not supported, show a message or link -->
                                        <p>Your browser does not support PDF viewing. You can <a href="{{ url($note->note_file) }}">download the PDF</a> instead.</p>
                                    </object>
                                </div>
                            </li>
                            <p> You can <a href="{{ url($note->note_file) }}">download the PDF</a> .</p>
